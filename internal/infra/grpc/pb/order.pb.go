...
func (x *FindOrderRequest) GetSort() string {
	if x != nil {
		return x.Sort
	}
	return ""
...
func (x *FindOrderRequest) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *FindOrderRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x28, 0x02, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x50,
	...
	0x22, 0x3c, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2f, 0x0a,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0x87,
	...
	0x00, 0x12, 0x35, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x12, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x70, 0x62, 0x2e, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x42, 0x18, 0x5a, 0x16, 0x69, 0x6e, 0x74, 0x65,
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []interface{}{
	...
	(*FindOrderRequest)(nil),    // 2: pb.FindOrderRequest
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	...
	2, // 2: pb.OrderService.FindAllOrder:input_type -> pb.FindOrderRequest
	1, // 3: pb.OrderService.CreateOrder:output_type -> pb.CreateOrderResponse
	3, // 4: pb.OrderService.FindAllOrder:output_type -> pb.OrderList
